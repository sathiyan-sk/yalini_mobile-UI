 ...
 *
 * Owns the `Settings` entry point and the destinations that the settings
 * rows route to. The Business module is fully wired here (My Business →
 * Add / Edit). Vehicles / Hotels / Assign Assets stay as placeholders
